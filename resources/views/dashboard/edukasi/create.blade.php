...
@section('content')
       <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Tambahkan Data</h1>
      </div>
      <div class="col-8">
          <form method="post" action="/dashboardEdukasi" enctype="multipart/form-data">
          @csrf
              <div class="mb-3">
              ...
              <div class="mb-3">
                  <label for="Jam" class="form-label @error('jam')
                      is-invalid
                  @enderror">Jam</label>
                  <input type="text" class="form-control" id="Jam" name="jam" value="{{ old('jam') }}" required>
                  @error('jam')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="Nomor Handphone" name="nomor_hp" value="{{ old('nomor_hp') }}" required>
                  @error('nomor_hp')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="twt" name="twt" value="{{ old('twt') }}" required>
                  @error('twt')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="iframe" name="iframe" value="{{ old('iframe') }}" required>
                  @error('iframe')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
